        ...
        <div>
            ...
            <div className="relative w-screen h-screen">
                ...
                <div className="w-fit h-fit absolute inset-0 bg-clip-text text-transparent bg-gradient-to-br from-black to-quaternary drop-shadow-lg">
                    ...
                    <p className="text-8xl font-instrumentSerif text-left pr-20 pl-20 pt-5 pb-20">
                        Services
                    </p>
                </div>
            ...
            <div className="p-20">
                <h2 className="font-instrumentSerif text-5xl mb-4">
                    Why you should use Charmbooking?
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 p-4">
                            ...
                            <p className="text-white">
                                Tailored beauty product suggestions based on user preferences,
                                medical conditions, and past bookings.
                            </p>
                        </div>
                    </div>
                    <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 p-4">
                            ...
                            <p className="text-white">
                                Locate nearby salons quickly with advanced search filters for
                    ...
                    <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 p-4">
                            ...
                            <p className="text-white">
                                Compare salon products by price, ingredients, reviews, and
                                suitability for personalized beauty needs.
                            </p>
                        </div>
                    </div>
                    <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 p-4">
                            ...
                            <p className="text-white">
                                Effortlessly schedule salon services with a user-friendly,

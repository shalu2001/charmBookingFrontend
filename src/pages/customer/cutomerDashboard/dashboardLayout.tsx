...
const sidebarItems = [
  { id: 'customerDashboard', label: 'Dashboard', icon: faMagic },
  { id: 'customerProfile', label: 'Profile', icon: faUser },
  { id: 'customerBookings', label: 'Bookings', icon: faCalendarAlt },
  { id: 'customerPayments', label: 'Payments', icon: faCreditCard },
]
        ...
        <div className='p-6 border-b border-sidebar-border'>
          <div className='flex items-center gap-3'>
            <div className='w-8 h-8 bg-gradient-to-br from-primary to-primary-dark rounded-lg flex items-center justify-center'>
              <FontAwesomeIcon icon={faMagic} className='w-4 h-4 text-primary-foreground' />
            </div>
            {!sidebarCollapsed && (
              <div>
                <h2 className='text-lg font-semibold text-sidebar-foreground'>CharmBooking</h2>
                <p className='text-xs text-sidebar-foreground/60'>Customer Dashboard</p>
              </div>
            )}
          </div>
        </div>

      ...
      <div className="p-20">
        ...
        <div className="font-instrumentSerif text-xl m-4 flex space-x-4">
          ...
          <div className="flex items-center">
              <StarRating name="read-only" value={salon?.rating} readOnly={true} size="medium" />
          </div>
        ...
        <div className="m-4 mt-20">
          <div className="flex flex-row items-center gap-4 font-instrumentSerif">
            ...
            <div className="mt-2 text-xl">{salon?.rating}</div>
            <div className="mt-3">
              <StarRating name="read-only" value={salon?.rating} readOnly={true} />
            </div>
          </div>
